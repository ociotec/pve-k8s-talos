...
cluster_identity_workspace=""
cluster_identity_config_workspace=""
cluster_platform_workspace=""
cluster_s3_storage_workspace=""
cluster_kafka_workspace=""
cluster_monitoring_workspace=""
cluster_benchmark_workspace=""
...
cluster_identity_constants_path=""
cluster_platform_constants_path=""
cluster_s3_storage_constants_path=""
cluster_kafka_constants_path=""
cluster_monitoring_constants_path=""
cluster_benchmark_constants_path=""
cluster_certs_dir=""
cluster_secrets_dir=""
cluster_credentials_path=""
cluster_credentials_report_path=""
...
setup_cluster_context() {
  ...
  cluster_identity_workspace="${cluster_out_dir}/identity"
  cluster_identity_config_workspace="${cluster_out_dir}/identity-config"
  cluster_platform_workspace="${cluster_out_dir}/platform"
  cluster_s3_storage_workspace="${cluster_out_dir}/s3-storage"
  cluster_kafka_workspace="${cluster_out_dir}/kafka"
  cluster_monitoring_workspace="${cluster_out_dir}/monitoring"
  cluster_benchmark_workspace="${cluster_out_dir}/benchmark"
  ...
  cluster_identity_constants_path="${cluster_dir}/identity_constants.tf"
  cluster_platform_constants_path="${cluster_dir}/platform_constants.tf"
  cluster_s3_storage_constants_path="${cluster_dir}/s3_storage_constants.tf"
  cluster_kafka_constants_path="${cluster_dir}/kafka_constants.tf"
  cluster_monitoring_constants_path="${cluster_dir}/monitoring_constants.tf"
  cluster_benchmark_constants_path="${cluster_dir}/benchmark_constants.tf"
  cluster_certs_dir="${cluster_dir}/certs"
  cluster_secrets_dir="${cluster_dir}/secrets"
  cluster_credentials_path="${cluster_secrets_dir}/credentials.json"
  cluster_credentials_report_path="${cluster_secrets_dir}/credentials_and_urls.md"
